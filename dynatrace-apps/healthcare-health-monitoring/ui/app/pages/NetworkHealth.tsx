...
export const NetworkHealth = () => {
  ...
  <Flex flexDirection="column" gap={16} padding={16}>
    ...
    <Flex gap={12} flexWrap="wrap">
      ...
      <KpiCard query={fn(queries.avgDeviceCpu)} label="Avg CPU" field="avg_cpu" format="percent" thresholds={{ green: 40, amber: 60 }} invertThresholds icon="💻" />
      <KpiCard query={fn(queries.avgDeviceMem)} label="Avg Memory" field="avg_mem" format="percent" thresholds={{ green: 60, amber: 75 }} invertThresholds icon="🧠" />
